...
ROUTER_PROMPT = ChatPromptTemplate([
    ("system", """You are an expert at routing user queries. Based on the user's latest message and the conversation history,
...
QUERY_CURATOR_PROMPT = ChatPromptTemplate([("system", """
...
QUERY_EXPANDER_PROMPT = ChatPromptTemplate([("system", """
...
RETRIEVAL_PROMPT = ChatPromptTemplate([("system", """
...
DIRECT_RESPONSE_PROMPT = ChatPromptTemplate([("system", """
